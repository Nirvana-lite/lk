...
metatagrazdel(
    'populyarnye-temy', // link
    'Популярные темы по юридическим вопросам', // title
    'Популярные темы',//SetTitle
    '', // tags
    ...
    'Популярные темы Российского Юридического портала jur24pro', // description
    'Популярные темы' // h1
);
?>
